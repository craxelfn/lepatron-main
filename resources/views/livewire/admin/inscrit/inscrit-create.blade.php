                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    ...
                    <div class="col-span-1 md:col-span-2 lg:col-span-2">
                        <label class="relative inline-flex items-center cursor-pointer">
                            <x-jet-checkbox wire:model.defer="newsgoal" id="newsgoal" type="text" class="sr-only peer" />
                    ...
                    <div class="col-span-1 md:col-span-2 lg:col-span-2">
                        <label class="relative inline-flex items-center cursor-pointer">
                            <x-jet-checkbox wire:model.defer="newspartenaire" id="newspartenaire" type="text" class="sr-only peer" />
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600"></div>
                    ...
                    <div class="col-span-1 md:col-span-2 lg:col-span-2">
                        <label class="relative inline-flex items-center cursor-pointer">
                            <x-jet-checkbox wire:model.defer="condition" id="condition" type="text" class="sr-only peer" />
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600"></div>
